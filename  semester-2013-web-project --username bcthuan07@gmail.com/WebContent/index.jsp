	...
	<div id="top" class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li><a href="">Đặt Bàn Trực Tuyến</a></li>
						<!--drop down menu-->
					...
					<a class="navbar-search pull-right"
						style="margin: 10px; font-size: 12pt;" href="login.jsp">Đăng Nhập</a>
					<%}else{ %>
					<a class="navbar-search pull-right"
			...
			<form class="navbar-form pull-right">
              ...
              <button type="submit" class="btn">ÄÄng Nháº­p</button>
            </form>
            <div class="nav-collapse collapse">
            <div class="nav pull-right">
            <a href="login.jsp" title="ÄÄng Nháº­p">ÄÄng Nháº­p</a>
            </div></div>-->
				</div>
				<!--/.nav-collapse -->
			</div>
			...
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						...
						<p class="lead">Đăng kí làm thành viên ngay bây giờ để nhận những lợi ích bất ngờ</p>
						<a class="btn btn-large btn-primary" href="#">Đăng Kí</a>
					</div>
				</div>
			</div>
			<div class="item">
				...
				<div class="container">
					<div class="carousel-caption">
						...
						<a class="btn btn-large btn-primary" href="#">Xem thÃªm</a>
					</div>
				</div>
			</div>
			<div class="item">
